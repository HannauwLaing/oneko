...
public class NekoSettings {
	...
	public int getSurpriseDelay() {
		return surpriseDelay;
	}

	public int getDoRandMov() {
		return doRandMov;
	}

	public int getRandSleepTime() {
		return randSleepTime;
	}

	public int getRandSleepWindow() {
		return randSleepWindow;
	}
	...
	public void load() {
		...
		randSleepTime = settings.getInt(RANDOM_MIN_SLEEP, 100);
		randSleepWindow = settings.getInt(RANDOM_WIN_SLEEP, 801);
	}
}
